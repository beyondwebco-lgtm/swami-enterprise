      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {verticals.map((vert) => (
            <div
              key={vert.id}
              className="glow-card glass-card flex flex-col justify-between p-6 rounded-[24px] border-[20px] border-[#8B6B1F] hover:border-[#C89B3C] shadow-xl shadow-[#8B6B1F]/25 hover:shadow-2xl hover:shadow-[#C89B3C]/35 hover:-translate-y-1.5 transition-all duration-300 relative group overflow-hidden"
            >
              <div>
                {/* Visual Image Banner */}
